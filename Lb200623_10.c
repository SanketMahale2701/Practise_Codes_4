 // Program 278
// Delete at position function with doubly linklist
...
int main()
{
    ...
    iRet = Count(frist);
    printf("The count of nodes are (InsertFrist) : %d\n",iRet);
    ...
    iRet = Count(frist);
    printf("The count of nodes are (DeleteFrist) : %d\n",iRet);
    ...
    iRet = Count(frist);
    printf("The count of nodes are (InsertAtPos) : %d\n",iRet);
    ...
    iRet = Count(frist);
    printf("The count of nodes are (DeleteAtPos) : %d\n",iRet);
    ...
    iRet = Count(frist);
    printf("The count of nodes are (DeleteLast) : %d\n",iRet);
